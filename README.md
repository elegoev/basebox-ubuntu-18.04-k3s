...
The base image is provisioned with bash script [ubuntu-18.04-k3s.sh](https://github.com/elegoev/vagrant-ubuntu1804-k3s/blob/master/provisioning/ubuntu-18.04-k3s.sh)
